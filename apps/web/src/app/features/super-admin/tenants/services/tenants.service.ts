...
export class TenantsService {
  ...
  create(payload: CreateTenantPayload): Observable<{ company: Tenant; tempPassword: string | null }> {
    return this.http.post<{ company: Tenant; tempPassword: string | null }>(this.baseUrl, payload);
  }
